      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am currently employed as a software developer at Opusify IT Solutions.
            <br />
            I have completed B.Tech Computer Science With specialization in Machine Learning at GLA University,
            Mathura.
            <br />
            <br />
